package com.geovis.client.handler;
...
public class ClentMsgHandler  extends ChannelInboundHandlerAdapter {


    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        String respStr = new StringBuilder("来自客户端的响应").append("lxzhdddddddd").append("$_").toString();
...
//      Delimiterread(ctx, msg);
    ...
    public void simpleRead(ChannelHandlerContext ctx, Object msg) throws UnsupportedEncodingException {
        ...
        String reqStr = new String(reqByte, Charset.forName("utf8"));
